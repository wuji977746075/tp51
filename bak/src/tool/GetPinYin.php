...
class GetPinYin {
    ...
    //全部拼音
    public function getAllPY($chinese, $delimiter = '', $utf8 = true, $length = 0) {
        if($utf8) $chinese = iconv('utf-8','gbk',$chinese);
    ...
    //拼音首个字母
    public function getFirstPY($chinese, $utf8 = true){
        if($utf8) $chinese = iconv('utf-8','gbk',$chinese);
        $result = '' ;
    ...
    private function zh_to_pys($chinese,  $delimiter = ' ', $first=0){
        ...
        for($i=0; $i<strlen($chinese); $i++) {
            ...
            $result[] = $this->zh_to_py($p, $delimiter);
            if ($first) {
                return $result[0];
            }
        }
