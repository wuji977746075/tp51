...
<div class="system-message">
    ...
    <?php if($code == 0){ ?>
            <div class="success"><span><?php echo($msg); ?></span></div>
    <?php }else{ ?>
            <div class="error"><span style="padding-top:0px;"><?php echo($msg); ?></span></div>
    <?php } ?>

    </div>
    <p class="detail"></p>
    <div class="jump" style="padding-right:5px;text-align:center;">
        <a id="href" class="btn"  href="<?php echo($url); ?>" style="color:#fff;">跳转（ <b id="wait"><?php echo($wait); ?></b> ）</a>
